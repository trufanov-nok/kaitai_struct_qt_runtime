...
# Compiles Kaitai Struct Qt runtime and tests
...
$(BUILD_DIR)/kaitaistream.o: kaitai-qt/kaitaistream.cpp kaitai-qt/kaitaistream.h
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(DEFINES) -c $< -o $@

$(BUILD_DIR)/unittest.o: tests/unittest.cpp tests/gtest-nano.h kaitai-qt/kaitaistream.h
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(DEFINES) -c $< -o $@
